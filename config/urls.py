...
urlpatterns = [
    ...
    # первый аргумент -- строковый кусочек пути запроса
    # второй аргумент -- действие, которое должно отработать, если есть совпадение по строковому пути (у нас это редирект, перенаправление)
